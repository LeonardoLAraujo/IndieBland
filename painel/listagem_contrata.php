<?php
    ...
    if(isset($_POST['txt_busca_usuario']) != ''){
        $sql = mysqli_query($conecta,"select * from cadastrar where nome like '{$_POST['txt_busca_usuario']}%' order by nome asc ");
    }else{
        $sql = mysqli_query($conecta,"select * from cadastrar order by nome asc");
    }

    if(isset($_GET['apagar'])){
        $sql = mysqli_query($conecta,"delete from cadastrar where nome=" .$_GET['apagar']);
